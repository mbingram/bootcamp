            ...
            {showMyOrders ?
                ...
                <div>
                    <div className='component__header flex-between'>
                        ...
                        <div className='tabs'>
                            <button onClick={(e) => tabHandler(e)} ref={orderRef} className='tab tab--active'>Orders</button>
                            <button onClick={(e) => tabHandler(e)} ref={tradeRef} className='tab'>Trades</button>
                        </div>
                    </div>
